...
**「この出来事は、一人で制作や発信を回している人に何が起きる？」**

ニュースや出来事の解説は書かない。書くのは「で、この読者に何が起きるか」だけ。
...
def build_prompt(board: str, neta: str, recent: str, target_date, needed, filled) -> str:
    ...
    sections += [
        *learning_section(),
        ...
        "",
        "## 長さと形",
        "- **本文は 80 字以内を基本にします。** 入りきらない分は迷わず thread に回します",
        "  （根拠: 会社アカウント @fukui._.fukui（旧 @urala._.fukui）の測定 79 本で、上位 10 本のうち 9 本が",
